...
cobbler_commit=c8e4af8affed82781212937c7655fd01f8488fec # v3.3.0
...
valid_git_checksum=11220100f5a017adb2a050a79f5ab8bc

git_checksum=$(find ./docker/cobbler_source/ -type f -exec md5sum {} \; | sort -k 2 | md5sum | awk '{print $1}')
if [ -d "./docker/cobbler_source" ] && [ $git_checksum == $valid_git_checksum ]; then
  ...
  git clone --shallow-since="2021-09-01" https://github.com/cobbler/cobbler.git -b master docker/cobbler_source
